...
t.test(flu_fitness$fitness==flu_total.CDF, flu_fitness$fitness==flu_random.CDF)
t.test(flu_fitness$fitness==flu_total.CDF, flu_fitness$fitness==flu_surface.CDF)
t.test(flu_fitness$fitness==flu_total.CDF, flu_fitness$fitness==flu_internal.CDF)

  #none are significantly different
#random
t.test(flu_fitness$fitness==flu_random.CDF, flu_fitness$fitness==flu_surface.CDF)
t.test(flu_fitness$fitness==flu_random.CDF, flu_fitness$fitness==flu_internal.CDF)
#surface
t.test(flu_fitness$fitness==flu_surface.CDF, flu_fitness$fitness==flu_internal.CDF)
  #none are significantly different
