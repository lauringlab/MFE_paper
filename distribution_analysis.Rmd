...
# READ IN FITNESS DATA FOR EACH VIRUS
  ...
  polio_fitness_df<-read.csv("~/Desktop/scripts/data/polio_fig_4_only.csv")
...
#big df with all fitness values w/non-lethals
...
#compare mean fitness for flu only
>>>>>>> 55c8786c5cd9df950fc1111e517487d9163aaa95
#total but does not make sense to do this test since these are all a subset of total:
t.test(Big_fitness_df$fitness==flu_total.CDF, Big_fitness_df$fitness==flu_random.CDF)
t.test(Big_fitness_df$fitness==flu_total.CDF, Big_fitness_df$fitness==flu_surface.CDF)
t.test(Big_fitness_df$fitness==flu_total.CDF, Big_fitness_df$fitness==flu_internal.CDF)

  #none are significantly different
#random
t.test(Big_fitness_df$fitness==flu_random.CDF, Big_fitness_df$fitness==flu_surface.CDF)
t.test(Big_fitness_df$fitness==flu_random.CDF, Big_fitness_df$fitness==flu_internal.CDF)
#surface
t.test(Big_fitness_df$fitness==flu_surface.CDF, Big_fitness_df$fitness==flu_internal.CDF)
  #none are significantly different


#ALL SUBSETS ARE THE SAME! CRAZY! 
